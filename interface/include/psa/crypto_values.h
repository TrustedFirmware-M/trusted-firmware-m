...
/* Extend PSA error codes */

/* Error codes are standardized across PSA domains (framework, crypto, storage,
 * etc.).
 * Standard errors come from PSA Certified as inlcuded in the header.
 * Beleow we add errors that are required for compatibility with MbedTLS.
 */
