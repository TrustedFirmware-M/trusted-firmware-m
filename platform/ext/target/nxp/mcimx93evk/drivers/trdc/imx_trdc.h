...
#define MBC_BLK_ALL	255u
#define MRC_REG_ALL	16u
#define GLBAC_NUM	8u

#define DID_NUM		16u
#define MBC_MAX_NUM	4u
#define MRC_MAX_NUM	2u
...
/* Additional TRDC config structure with only MBC */
struct trdc_mbc_config_info {
	uintptr_t trdc_base;
	struct trdc_mbc_config *mbc_cfg;
	uint32_t num_mbc_cfg;
};
