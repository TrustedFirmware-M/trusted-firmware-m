...
DEFAULT_IRQ_HANDLER(TFM_FPU_S_TEST_Handler)
DEFAULT_IRQ_HANDLER(TFM_FPU_NS_TEST_Handler)
...
/* External interrupts */
  ...
  TFM_FPU_S_TEST_Handler,            /* 77: TFM FPU Secure Test Interrupt */
  TFM_FPU_NS_TEST_Handler,           /* 78: TFM FPU Non-Secure Test Interrupt */
};
...
{
    uint32_t cpu_identity = *(volatile uint32_t*) MUSCA_S1_CPU_IDENTITY_S_BASE;
