...
if (TFM_PLATFORM_VARIANT STREQUAL "0")
    ...
    set(MULTI_RSE_TOPOLOGY_FILE         ${CMAKE_CURRENT_LIST_DIR}/sfcp/rdv3r1.tgf CACHE STRING "Topology file for RSE to RSE BL1 communication")
else()
    set(RSE_AMOUNT                      4        CACHE STRING  "Amount of RSEs in the system")
    set(PLAT_LCP_COUNT                  2        CACHE STRING  "Number of LCPs to load")
    set(MULTI_RSE_TOPOLOGY_FILE         ${CMAKE_CURRENT_LIST_DIR}/sfcp/rdv3r1cfg1.tgf CACHE STRING "Topology file for RSE to RSE BL1 communication")
endif()
