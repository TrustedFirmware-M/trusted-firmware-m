...
enum tfm_plat_err_t {
    ...
    TFM_PLAT_ERR_OTP_INIT_CM_ROTPK_ZERO_COUNT_ERR,
    TFM_PLAT_ERR_OTP_INIT_DM_ROTPK_ZERO_COUNT_ERR,
    ...
    TFM_PLAT_ERR_ROTPK_REVOCATION_INVALID_INDEX,
    ...
    TFM_PLAT_ERR_PROVISIONING_INVALID_MESSAGE_SEQUENCING,
    ...
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_CM_ROTPK_LCS,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_DM_ROTPK_LCS,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_ROTPK_CONFIG,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_NOT_IN_ROM_ROTPK_CONFIG,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_CODE_SIZE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_DATA_SIZE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_VALUES_SIZE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_TAG_LEN,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_CM_ROTPK,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_CURVE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_HASH_SIZE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_HASH_VALUE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_HASH_ALG,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_SIZE,
    TFM_PLAT_ERR_PROVISIONING_BLOB_ZERO_CODE_SIZE,
    TFM_PLAT_ERR_PROVISIONING_BLOB_INVALID_DM_ROTPK_SIGNATURE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_PLAIN_DATA_INVALID_SIZE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_PLAIN_DATA_INVALID_ROTPK,
    TFM_PLAT_ERR_PROVISIONING_AUTH_PLAIN_DATA_INVALID_NON_ROM_ROTPK,
    ...
    TFM_PLAT_ERR_PROVISIONING_MESSAGE_NO_AUTH_PLAIN_DATA_HANDLER,
    ...
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_DECRYPTION_CONFIG,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_PURPOSE,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_LCS,
    TFM_PLAT_ERR_PROVISIONING_AUTH_MSG_INVALID_TP_MODE,
    ...
    TFM_PLAT_ERR_PROVISIONING_PLAIN_DATA_INVALID_REVOCATION_SIZE,
    ...
    TFM_PLAT_ERR_PROVISIONING_PLAIN_DATA_INVALID_LCS,
    TFM_PLAT_ERR_PROVISIONING_PLAIN_DATA_INVALID_AUTH,
    TFM_PLAT_ERR_PROVISIONING_PLAIN_DATA_INVALID_SIGNATURE_CONFIG,
    ...
    TFM_PLAT_ERR_KEY_DERIVATION_INVALID_SESSION_KEY_OUTPUT_SLOT,
    ...
    TFM_PLAT_ERR_HOST_FLASH_SETUP_IMAGE_SLOT_GPT_PARTITION_NOT_FOUND,
    TFM_PLAT_ERR_HOST_FLASH_ATU_INVALID_INPUT,
    /* RSE FWU metadata error codes */
    TFM_PLAT_ERR_FWU_METADATA_INVALID_INPUT,
    TFM_PLAT_ERR_FWU_METADATA_INVALID_SIZE,
    TFM_PLAT_ERR_FWU_METADATA_FLASH_READ_FAILED,
    TFM_PLAT_ERR_FWU_METADATA_FLASH_ERASE_FAILED,
    TFM_PLAT_ERR_FWU_METADATA_FLASH_WRITE_FAILED,
    TFM_PLAT_ERR_FWU_METADATA_CRC_MISMATCH,
    TFM_PLAT_ERR_FWU_METADATA_INVALID_BANK_INDEX,
    TFM_PLAT_ERR_FWU_METADATA_IMAGE_NOT_FOUND,
    ...
    TFM_PLAT_ERR_DCU_FEATURE_CONTROL_EXCEED_LIMIT,
    TFM_PLAT_ERR_DCU_FEATURE_CONTROL_SIGNAL_DISABLED,
    TFM_PLAT_ERR_DCU_FEATURE_CONTROL_ERROR,
    /* Generic errors */
