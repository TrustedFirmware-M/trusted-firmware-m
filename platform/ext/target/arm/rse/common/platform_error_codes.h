...
enum tfm_plat_err_t {
    ...
    /* IAK endorsement certificate handling */
    TFM_PLAT_ERR_IAK_ENDORSEMENT_SIGNATURE_INVALID_SIZE,
    TFM_PLAT_ERR_IAK_ENDORSEMENT_SKI_INVALID_SIZE,
    TFM_PLAT_ERR_IAK_ENDORSEMENT_SERIAL_NUMBER_INVALID_SIZE,
    TFM_PLAT_ERR_IAK_ENDORSEMENT_KEY_INVALID_SIZE,
    /* Generic errors */
