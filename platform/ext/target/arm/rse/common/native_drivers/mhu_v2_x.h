...
#else
#define MHU_V_2_X_ERROR_BASE 0x1u
...
enum mhu_v2_x_error_t {
    MHU_V_2_X_ERR_NONE = 0x0u,
    MHU_V_2_X_ERR_INIT_UNSUPPORTED_VERSION = MHU_V_2_X_ERROR_BASE,
    MHU_V_2_X_ERR_GET_NUM_CHANNEL_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_SEND_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_SEND_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_POLL_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_POLL_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_CLEAR_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_CLEAR_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_RECEIVE_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_RECEIVE_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_MASK_SET_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_MASK_SET_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_MASK_CLEAR_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_MASK_CLEAR_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_INT_ENABLE_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_INT_ENABLE_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_CHANNEL_INT_ENABLE_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_INT_DISABLE_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_INT_DISABLE_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_CHANNEL_INT_DISABLE_INVALID_ARG,
    MHU_V_2_X_ERR_CHANNEL_INT_CLEAR_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CHANNEL_INT_CLEAR_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_CHANNEL_INT_CLEAR_INVALID_ARG,
    MHU_V_2_X_ERR_INIT_TRANSFER_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INIT_TRANSFER_INVALID_ARG,
    MHU_V_2_X_ERR_CLOSE_TRANSFER_MHU_NOT_INIT,
    MHU_V_2_X_ERR_CLOSE_TRANSFER_INVALID_ARG,
    MHU_V_2_X_ERR_GET_ACESS_REQUEST_MHU_NOT_INIT,
    MHU_V_2_X_ERR_GET_ACESS_REQUEST_INVALID_ARG,
    MHU_V_2_X_ERR_SET_ACESS_REQUEST_MHU_NOT_INIT,
    MHU_V_2_X_ERR_SET_ACESS_REQUEST_INVALID_ARG,
    MHU_V_2_X_ERR_RESET_ACESS_REQUEST_MHU_NOT_INIT,
    MHU_V_2_X_ERR_RESET_ACESS_REQUEST_INVALID_ARG,
    MHU_V_2_X_ERR_GET_ACESS_READY_MHU_NOT_INIT,
    MHU_V_2_X_ERR_GET_ACESS_READY_INVALID_ARG,
    MHU_V_2_X_ERR_GET_INTERRUPT_STATUS_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INTERRUPT_ENABLE_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INTERRUPT_ENABLE_INVALID_ARG,
    MHU_V_2_X_ERR_INTERRUPT_ENABLE_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_INTERRUPT_DISABLE_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INTERRUPT_DISABLE_INVALID_ARG,
    MHU_V_2_X_ERR_INTERRUPT_DISABLE_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_INTERRUPT_CLEAR_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INTERRUPT_CLEAR_INVALID_ARG,
    MHU_V_2_X_ERR_INTERRUPT_CLEAR_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_INTERRUPT_CHANNEL_NUM_MHU_NOT_INIT,
    MHU_V_2_X_ERR_INTERRUPT_CHANNEL_NUM_UNSUPPORTED_VERSION,
    MHU_V_2_X_ERR_INTERRUPT_CHANNEL_NUM_GENERAL,
    MHU_V_2_X_ERR_FORCE_UINT_SIZE = UINT_MAX,
};
