...
#ifndef __SFCP_PERMISSIONS_HAL_H__
#define __SFCP_PERMISSIONS_HAL_H__
...
/**
 * \brief Check that SFCP callers have permission to access a memory
 *        buffer.
 *
 ...
 *                               occurred.
 */
enum tfm_plat_err_t comms_permissions_memory_check(sfcp_node_id_t node_id, uint64_t host_ptr,
                                                   uint32_t size, bool is_write);

/**
 * \brief Check that SFCP callers have permission to access a service.
 *
 ...
 *                               occurred.
 */
enum tfm_plat_err_t comms_permissions_service_check(psa_handle_t handle, const psa_invec *in_vec,
                                                    size_t in_len, int32_t type);

#ifdef __cplusplus
}
#endif

#endif /* __SFCP_PERMISSIONS_HAL_H__ */
