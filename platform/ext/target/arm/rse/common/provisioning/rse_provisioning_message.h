...
enum rse_provisioning_auth_msg_non_rom_pk_type_config_t {
    RSE_PROVISIONING_AUTH_MSG_DETAILS_NON_ROM_PK_TYPE_CM_ROTPK          = 0b00,
    RSE_PROVISIONING_AUTH_MSG_DETAILS_NON_ROM_PK_TYPE_PREVIOUS_MESSAGE  = 0b01,
    /* FixMe: Confirm that this enum value is correct */
    RSE_PROVISIONING_AUTH_MSG_DETAILS_NON_ROM_PK_TYPE_DM_ROTPK          = 0b10,
};
