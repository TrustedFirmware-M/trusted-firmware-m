                                                   ...
                                                   uint32_t size, bool is_write)
{
    if (node_id == AP_S_NODE_ID) {
        ...
        if (host_ptr >= HOST_AP_SHARED_SRAM_PHYS_BASE &&
            size <= (HOST_AP_SHARED_SRAM_PHYS_LIMIT - HOST_AP_SHARED_SRAM_PHYS_BASE) &&
        ...
        if (host_ptr >= HOST_AP_MHU_POINTER_ACCESS_PHYS_BASE &&
            size <=
                (HOST_AP_MHU_POINTER_ACCESS_PHYS_LIMIT - HOST_AP_MHU_POINTER_ACCESS_PHYS_BASE) &&
