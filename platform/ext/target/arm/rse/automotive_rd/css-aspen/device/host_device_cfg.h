...
#define MHU_RSE_TO_SI_CL0_DEV     MHU_SI_CL0_SENDER_DEV_S
#define MHU_SI_CL0_TO_RSE_DEV     MHU_SI_CL0_RECEIVER_DEV_S
#define MHU_SI_CL0_TO_RSE_IRQn    SI_CL0_RSE_CMU_MHU_Receiver_IRQn
