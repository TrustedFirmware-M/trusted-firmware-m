...
0x21000000+--------+      |  +--------+      |       |  |            |  |      S      |  |       X       |
          | ISRAM0 |      |  | ISRAM0 |      |       |  |            |  |             |  |               |
0x21020000+--------+      |  +--------+      |       |  |            |  +-------------+  +---------------+
          | ISRAM0 |      |  | ISRAM0 |      |       |  |            |  |  (MPC) NS   |  |       NS      |
0x21100000+--------+      |  +--------+      |       |  |            |  +-------------+  +---------------+
0x21200000+--------+      |  +--------+      |       |  |            |  +-------------+  +---------------+ (for AN547)
          | ISRAM1 |      |  | ISRAM1 |      |       |  |            |  |  (MPC) NS   |  |       NS      |
0x21200000+--------+      |  +--------+      |       |  |            |  +-------------+  +---------------+
...
#ifdef CORSTONE300_FVP /* FVP requires separate blocks for peripherals and DDR4 */
