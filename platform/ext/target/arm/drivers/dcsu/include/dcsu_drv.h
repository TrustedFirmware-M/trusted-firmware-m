...
enum dcsu_rx_command {
    ...
    DCSU_RX_COMMAND_GENERATE_SOC_UNIQUE_ID = 0x1,
    DCSU_RX_COMMAND_WRITE_SOC_FAMILY_ID = 0x2,
    DCSU_RX_COMMAND_WRITE_SOC_IEEE_ECID = 0x3,
    DCSU_RX_COMMAND_COMPUTE_ZC_SOC_IDS = 0x4,
    DCSU_RX_COMMAND_READ_SOC_FAMILY_ID = 0x5,
    DCSU_RX_COMMAND_READ_SOC_IEEE_ECID = 0x6,
    DCSU_RX_COMMAND_WRITE_SOC_CONFIG_DATA = 0x7,
    DCSU_RX_COMMAND_COMPUTE_ZC_SOC_CFG = 0x8,
    DCSU_RX_COMMAND_READ_SOC_CONFIG_DATA = 0x9,
    ...
    DCSU_RX_COMMAND_SET_SE_DEV = 0x10,
    DCSU_RX_COMMAND_SET_PS_FC = 0x11,
...
enum dcsu_rx_msg_response_t {
    ...
    DCSU_RX_MSG_RESP_INVALID_CONTROL_PARAMETER = 0x13,
    DCSU_RX_MSG_RESP_INVALID_CONTROL_NUMBER = 0x14,
    DCSU_RX_MSG_RESP_GENERIC_ERROR = 0xFE,
