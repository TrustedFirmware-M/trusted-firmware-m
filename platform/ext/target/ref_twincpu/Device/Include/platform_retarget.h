 ...
 * \brief This file defines all the peripheral base addresses for ref twincpu platform.
 */

#ifndef __ARM_LTD_REF_TWINCPU_RETARGET_H__
#define __ARM_LTD_REF_TWINCPU_RETARGET_H__
...
#endif  /* __ARM_LTD_REF_TWINCPU_RETARGET_H__ */
