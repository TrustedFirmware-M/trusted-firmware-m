...
struct tfm_spm_partition_platform_data_t tfm_peripheral_std_uart = {
        REF_TWINCPU_UART1_NS_BASE,
        REF_TWINCPU_UART1_NS_BASE + 0xFFF,
...
void mpc_init_cfg(void)
{
    ...
    /* To run the regression tests on ref_twincpu it is required to assign more
...
void ppc_init_cfg(void)
{
    ...
    spctrl->ahbnsppcexp0 = (1U << REF_TWINCPU_PERIPHS_AHB_PPC_POS);

    /* in NS, grant un-privileged for AHB peripherals on EXP0 */
    nspctrl->ahbnspppcexp0 = (1U << REF_TWINCPU_PERIPHS_AHB_PPC_POS);
