...
set(UNIT_TEST_SUITE ${CMAKE_CURRENT_LIST_DIR}/test_gpt_io.c)
...
list(APPEND UNIT_TEST_INCLUDE_DIRS ${TFM_ROOT_DIR}/lib/gpt/src/io)
...
list(APPEND MOCK_HEADERS ${TFM_ROOT_DIR}/lib/gpt/src/io/gpt_io_write.h)
list(APPEND MOCK_HEADERS ${TFM_ROOT_DIR}/lib/gpt/src/io/gpt_io_read.h)
